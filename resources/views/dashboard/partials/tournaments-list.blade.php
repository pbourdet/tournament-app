<div>
    ...
    <div class="mt-2">
        @foreach ($tournaments as $tournament)
            <a href="{{ route('tournaments.show', ['tournament' => $tournament]) }}" wire:navigate class="block border rounded-lg border-gray-200 hover:bg-gray-200 hover:shadow-md transition duration-150">

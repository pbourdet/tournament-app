<div x-data="{ editing: false, loading: false, generationInProgress: @js($generationInProgress) }"
    ...
    <div class="px-4 py-3 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
        <div class="flex flex-col truncate">
            <flux:heading class="truncate" x-show="!editing" size="lg" x-text="$wire.newName"></flux:heading>
        ...
        <div class="flex items-center space-x-2 ml-2">
            @can('manage', $tournament)
                ...
                <flux:button square x-show="editing" @click="editing = false;">
                ...
                <flux:button square variant="danger"
                    ...
                    <x-loader x-show="loading" class="size-5"/>
                </flux:button>
            @endcan
        </div>
    </div>
